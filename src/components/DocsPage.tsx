...
export default function DocsPage({ onNavigateToAuth }: { onNavigateToAuth?: () => void }) {
  return (
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-16">
          ...
          <section className="border border-foreground/20 p-8 space-y-4">
            ...
            <nav className="space-y-2 text-sm">
              <a href="#tech-stack" className="block text-foreground/60 hover:text-foreground transition-colors font-light">Tech Stack Requirements</a>
              <a href="#backend-setup" className="block text-foreground/60 hover:text-foreground transition-colors font-light">Backend Setup</a>
              <a href="#frontend-setup" className="block text-foreground/60 hover:text-foreground transition-colors font-light">Frontend Setup</a>
              <a href="#dashboard-usage" className="block text-foreground/60 hover:text-foreground transition-colors font-light">Using the Dashboard</a>
              <a href="#sdk-setup" className="block text-foreground/60 hover:text-foreground transition-colors font-light">SDK Integration</a>
              <a href="#api-reference" className="block text-foreground/60 hover:text-foreground transition-colors font-light">API Reference</a>
            </nav>
          </section>
